...
- What is presented is for windows forms `but` there are some annotations that can be ported to ASP.NET Core
- Orignally done in VB.NET .NET Framwork and ported to C# 9, .NET Core 5
